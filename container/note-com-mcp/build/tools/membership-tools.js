...
import { formatMembershipSummary, formatMembershipPlan, formatMembershipNote, } from "../utils/formatters.js";
import { createSuccessResponse, createAuthErrorResponse, handleApiError, safeExtractData, commonExtractors, } from "../utils/error-handler.js";
    ...
    server.tool("get-membership-notes", "メンバーシップの記事一覧を取得する", {
        ...
        try {
            ...
            const formattedMembership = {
                ...
                creatorName: membershipInfo?.creator?.nickname ||
                    membershipInfo?.creatorName ||
                    "",
